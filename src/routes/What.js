...
function What() {
    ...
    const getTVs = async() => {
        const json = await (await fetch("https://api.themoviedb.org/3/tv/popular?api_key=6df683327f9037c362fcff75540a2656&language=en-US&page=1"))
        .json();
    ...
    return(
        <div className={styles.wrapper}>
            ...
            <div className={styles.gridContainer}>
                <div
                className={styles.Netflix}></div>
                <div
                className={styles.Disney}></div>
                <div></div>
                <div></div>
                <div></div>
                <div></div>
